...
export function Winner({ state }: { state: Game }) {
    ...
    alert(`Vítězem je ${state.winner}
        Hráč 1. ${state.player1.buttons} knoflíků
        Hráč 2. ${state.player2.buttons} knoflíků`);
    return <></>;
        ...
        >
            ...
            >
                ...
                <div className="relative p-4 font-sans text-base antialiased font-light leading-relaxed border-t border-b border-t-blue-gray-100 border-b-blue-gray-100 text-blue-gray-500">
                    <div>Hráč 1. {state.player1.buttons} knoflíků</div>
                    <div>Hráč 2. {state.player2.buttons} knoflíků</div>
                </div>
