...
export function Winner({ player1, player2, winner, dispatch }: WinnerProps) {
    ...
    return (
        <dialog
            ref={dialogRef}
            className="relative mt-4 ml-auto mr-auto w-2/5 min-w-[40%] max-w-[40%] rounded-lg bg-white font-sans text-base font-light leading-relaxed text-blue-gray-500 antialiased shadow-2xl backdrop-grayscale"
        >
